...
\subsection{预备知识} \label{preliminary}
...
\subsection{非目标动作差异攻击} \label{Normalized_Action_Discrepancy_Attack}
...
\subsection{非目标位置感知攻击} \label{Geometry_aware_Attack}
...
\subsection{目标操控攻击}\label{Target_Attack}
...
\subsection{指标：归一化动作差异} \label{NAD_metric}
